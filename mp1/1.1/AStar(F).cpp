    ...
    public:
        ...
        void updateGValue(const int & i, int prev) // i: direction
        {
            if(ruleMode == 0){
                ...
                updateGValueRule1(i, prev);
            }
            else if(ruleMode == 2){
                updateGValueRule2(i, prev);
            }
            else if(ruleMode == 3){
                updateGValueRule3(i, prev);
            }
        }

        void updateGValueRule1(const int & i, int prev) // i: direction
        {
            if(prev==i){
            ...
            GValue += 2;//forward cost2
        }

        void updateGValueRule2(const int & i, int prev) // i: direction
        {
            if(prev==i){
                //didn't change direction
            }
        ...
        void updateGValueRule3(const int & i, int prev) // i: direction
        {
            GValue++;
        }
...
*/
		...
		// already in the open list
                else if(openNodes[jNext][iNext] > pNode2->getFValue()) {
